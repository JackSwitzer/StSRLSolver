...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| GAP-REL-001 | relics | `Orrery` | `relics/Orrery.java::onEquip` | `packages/engine/state/run.py` | `_on_relic_obtained` | action-surface-missing | `card_rng` | implicit_ui | `tests/test_relic_pickup.py` | `tests/test_agent_api.py` + new R1 selection tests | P0 | REL-003 | R1 | currently auto-picks first offered card for each set |
