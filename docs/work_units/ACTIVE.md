...
- [observation](granular-observation.md) -- Observation schema
- [determinism](granular-determinism.md) -- RNG/determinism rules
- [phase-flow](granular-phase-flow.md) -- State machine transitions
