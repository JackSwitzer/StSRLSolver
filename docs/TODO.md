...
This TODO list is scoped to the stacked training rebuild branch.
...
- strategic/pathing learner on top of the combat solver
- richer run import pipeline for Baalorlord and other reference runs
- long-horizon resource tradeoff learning above the local combat frontier
