...
| BOSS_RELIC {pick / SKIP} | `BossRelicSelectScreen.update()` obtain commit — REFINE-AT-P2: patch the relic-obtain call inside update, plus skip button | class confirmed |
