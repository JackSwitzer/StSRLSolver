...
- card files with empty `effect_data`: `13`
- card files still using `complex_hook`: `13`
- unresolved public card files (union of empty typed programs and hook-backed files): `16`
