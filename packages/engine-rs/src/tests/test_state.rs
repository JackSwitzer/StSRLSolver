...
mod state_tests {
    ...
    #[test]
    fn entity_dead_at_zero() {
        let mut e = EntityState::new(50, 50);
        e.hp = 0;
        assert!(e.is_dead());
    }
    #[test]
    fn enemy_alive_check() {
