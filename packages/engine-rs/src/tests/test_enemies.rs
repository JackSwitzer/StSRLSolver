...
mod enemy_tests {
    ...
    #[test]
    fn jw_after_chomp_middle_window_is_thrash() {
    ...
    #[test]
    fn jw_after_thrash_high_window_is_bellow() {
        let mut e = create_enemy("JawWorm", 44, 44);
        roll_next_move_with_num(&mut e, 30);
    ...
    fn jw_6_turn_cycle() {
        ...
        assert_eq!(
            ids,
            vec![JW_CHOMP, JW_THRASH, JW_BELLOW, JW_THRASH, JW_CHOMP, JW_BELLOW]
        );
    }
    #[test]
    fn jw_bellow_has_no_damage() {
        let mut e = create_enemy("JawWorm", 44, 44);
    ...
    #[test]
    fn cult_always_dark_strike_after() {
        let mut e = create_enemy("Cultist", 50, 50);
        for _ in 0..10 {
            roll_next_move(&mut e, &mut crate::seed::StsRandom::new(0));
            assert_eq!(e.move_id, CULT_DARK_STRIKE);
    ...
    #[test]
    fn cult_source_pattern_and_ai_rng_ticks() {
        let mut e = create_enemy("Cultist", 50, 50);
        assert_eq!(e.move_id, CULT_INCANTATION);
        assert_eq!(e.move_damage(), 0);
        assert_eq!(e.effect(mfx::RITUAL).unwrap(), 3);
        ...
        for turn in 1..=8 {
            ...
            assert_eq!(
                ai_rng.counter, turn,
                "one aiRng tick per roll (turn {turn})"
            );
        }
    }
    ...
    #[test]
    fn fb_initial_roll_uses_java_60_percent_split() {
        // Source: reference/extracted/methods/monster/FungiBeast.java (`getMove`).
        let mut bite = create_enemy("FungiBeast", 24, 24);
        roll_initial_move_with_num_and_rng(&mut bite, 59, &mut crate::seed::StsRandom::new(0));
    ...
    #[test]
    fn green_louse_initial_roll_uses_java_25_percent_web_split() {
        // Source: reference/extracted/methods/monster/LouseDefensive.java.
        let mut web = create_enemy("GreenLouse", 14, 14);
        roll_initial_move_with_num_and_rng(&mut web, 24, &mut crate::seed::StsRandom::new(0));
    ...
    #[test]
    fn green_louse_curl_up() {
        let e = create_enemy("GreenLouse", 14, 14);
        assert!(e.entity.status(sid::CURL_UP) > 0);
    }
    #[test]
    fn green_louse_spit_web_weak() {
    ...
    #[test]
    fn louse_a17_prevents_consecutive_special_moves() {
        ...
        roll_initial_move_with_num_and_rng(&mut low, 0, &mut crate::seed::StsRandom::new(0));
    ...
    #[test]
    fn bs_initial_roll_uses_java_60_percent_stab_split() {
        // Source: reference/extracted/methods/monster/SlaverBlue.java.
        let mut rake = create_enemy("SlaverBlue", 48, 48);
        roll_initial_move_with_num_and_rng(&mut rake, 39, &mut crate::seed::StsRandom::new(0));
        ...
        roll_initial_move_with_num_and_rng(&mut stab, 40, &mut crate::seed::StsRandom::new(0));
        assert_eq!(stab.move_id, BS_STAB);
        assert_eq!(stab.move_damage(), 12);
    }
    #[test]
    fn bs_no_three_stabs() {
    ...
    #[test]
    fn bs_a17_prevents_consecutive_rakes() {
    ...
    #[test]
    fn rs_first_stab_ignores_initial_num() {
        // Source: reference/extracted/methods/monster/SlaverRed.java.
        for num in [0, 99] {
            let mut e = create_enemy("SlaverRed", 48, 48);
            roll_initial_move_with_num_and_rng(&mut e, num, &mut crate::seed::StsRandom::new(0));
    ...
    #[test]
    fn rs_a17_prevents_consecutive_scrapes() {
    ...
    #[test]
    fn acid_s_initial_rng_and_a17_opener_match_java() {
    ...
    #[test]
    fn acid_m_initial_windows_match_java_at_a0_and_a17() {
        ...
        for (num, move_id) in [(39, AS_CORROSIVE_SPIT), (40, AS_TACKLE), (80, AS_LICK)] {
            ...
            roll_initial_move_with_num_and_rng(&mut e, num, &mut crate::seed::StsRandom::new(1));
            assert_eq!(e.move_id, move_id);
        }
    }
    #[test]
    ...
    #[test]
    fn acid_m_repeated_wound_uses_secondary_boolean_draw() {
        let seed_for = |expected: bool| {
            (1..10_000)
                .find(|&seed| {
                    let mut rng = crate::seed::StsRandom::new(seed);
    ...
    #[test]
    fn acid_m_probability_guards_consume_one_float_draw() {
        let seed_for = |below: f32, expected: bool| {
            (1..10_000)
                .find(|&seed| {
                    let mut rng = crate::seed::StsRandom::new(seed);
    ...
    #[test]
    fn acid_l_initial_windows_and_a17_thresholds_match_java() {
    ...
    #[test]
    fn acid_l_a17_repeated_wound_uses_point_six_draw() {
        let seed_for = |expected: bool| {
            (1..10_000)
                .find(|&seed| {
                    let mut rng = crate::seed::StsRandom::new(seed);
    ...
    #[test]
    fn spike_m_initial_window_and_tackle_slimed_match_java() {
        // Source: reference/extracted/methods/monster/SpikeSlime_M.java.
        let mut tackle = create_enemy("SpikeSlime_M", 28, 28);
        roll_initial_move_with_num_and_rng(&mut tackle, 29, &mut crate::seed::StsRandom::new(1));
        ...
        roll_initial_move_with_num_and_rng(&mut lick, 30, &mut crate::seed::StsRandom::new(1));
        assert_eq!(lick.move_id, SS_LICK);
        assert_eq!(lick.effect(mfx::FRAIL), Some(1));
    }
    #[test]
    fn spike_m_no_three_tackles() {
    ...
    #[test]
    fn spike_m_a17_prevents_consecutive_licks() {
        let mut low = create_enemy("SpikeSlime_M", 28, 28);
        roll_initial_move_with_num_and_rng(&mut low, 30, &mut crate::seed::StsRandom::new(1));
        ...
        roll_initial_move_with_num_and_rng(&mut a17, 30, &mut crate::seed::StsRandom::new(1));
    ...
    #[test]
    fn spike_l_initial_window_and_tackle_slimed_match_java() {
    ...
    #[test]
    fn spike_l_a17_prevents_consecutive_licks_and_applies_three_frail() {
    ...
    #[test]
    fn sentry_alternates_bolt_beam() {
        let mut e = create_enemy("Sentry", 38, 38);
        roll_initial_move_with_num_and_rng(&mut e, 0, &mut crate::seed::StsRandom::new(1));
        roll_next_move(&mut e, &mut crate::seed::StsRandom::new(0));
    ...
    #[test]
    fn guard_switch_back_to_offensive() {
        let mut e = create_enemy("TheGuardian", 240, 240);
        guardian_check_mode_shift(&mut e, 30);
    ...
    #[test]
    fn sb_split_intent_is_unknown() {
        // Source: reference/extracted/methods/monster/SlimeBoss.java (`damage`
        // and `takeTurn` case 3): both Split assignments use UNKNOWN. Damage's
        // direct setMove plus queued SetMoveAction each append Split to Java's
        // history after preserving the interrupted current move.
        ...
        assert_eq!(e.move_history, vec![SB_STICKY, SB_SPLIT]);
        assert_eq!(
            e.move_history
                .iter()
                .copied()
                .chain(std::iter::once(e.move_id))
                .collect::<Vec<_>>(),
            vec![SB_STICKY, SB_SPLIT, SB_SPLIT]
        );
    }
    #[test]
    fn sb_split_at_50pct() {
        let mut e = create_enemy("SlimeBoss", 140, 140);
    ...
    #[test]
    fn sb_split_below_50pct() {
        let mut e = create_enemy("SlimeBoss", 140, 140);
        e.entity.hp = 50;
        assert!(slime_boss_should_split(&e));
    }
    #[test]
    fn sb_no_split_at_71() {
        let mut e = create_enemy("SlimeBoss", 140, 140);
        e.entity.hp = 71;
        assert!(!slime_boss_should_split(&e));
    }
    #[test]
    fn sb_no_split_if_dead() {
        let mut e = create_enemy("SlimeBoss", 140, 140);
        e.entity.hp = 0;
        assert!(!slime_boss_should_split(&e));
    }
    ...
    #[test]
    fn nob_bellow_applies_enrage_during_its_turn() {
    ...
    #[test]
    fn nob_pre_a18_uses_33_percent_bash_split() {
    ...
    #[test]
    fn nob_a18_forces_bash_after_two_turns_without_one() {
    ...
    fn nemesis_scythe_attack() {
        ...
        assert!(
            has_scythe,
            "Nemesis should have a high-damage scythe attack"
        );
    }
