...
#[test]
fn watcher_wave16_registry_exports_foreign_influence_as_typed_generated_choice() {
...
#[test]
fn watcher_wave16_foreign_influence_preserves_base_cost_and_zeros_upgraded_cost() {
...
fn watcher_wave16_omniscience_stays_queued_until_choice_primitive_exists() {}
...
fn watcher_wave16_wish_stays_queued_until_payload_driven_option_resolution_exists() {}
