...
#[test]
#[ignore = "Enlightenment still needs a turn-only cost-reduction primitive; Java updates costForTurn for the turn and only permanently reduces upgraded cards."]
