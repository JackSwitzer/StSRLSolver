...
mod damage_tests {
    ...
    #[test]
    fn basic_0() {
        assert_eq!(calculate_damage(0, 0, false, 1.0, false, false), 0);
    }
    #[test]
    fn basic_1() {
        assert_eq!(calculate_damage(1, 0, false, 1.0, false, false), 1);
    }
    #[test]
    fn basic_100() {
        assert_eq!(calculate_damage(100, 0, false, 1.0, false, false), 100);
    }
    ...
    #[test]
    fn str_large() {
        assert_eq!(calculate_damage(6, 10, false, 1.0, false, false), 16);
    }
    #[test]
    fn str_negative() {
        assert_eq!(calculate_damage(6, -2, false, 1.0, false, false), 4);
    }
    #[test]
    fn str_neg_floor_zero() {
        assert_eq!(calculate_damage(5, -10, false, 1.0, false, false), 0);
    }
    #[test]
    fn str_neg_exact_zero() {
        assert_eq!(calculate_damage(5, -5, false, 1.0, false, false), 0);
    }
    ...
    #[test]
    fn weak_8() {
        assert_eq!(calculate_damage(8, 0, true, 1.0, false, false), 6);
    }
    #[test]
    fn weak_11() {
        assert_eq!(calculate_damage(11, 0, true, 1.0, false, false), 8);
    }
    #[test]
    fn weak_13() {
        assert_eq!(calculate_damage(13, 0, true, 1.0, false, false), 9);
    }
    #[test]
    fn weak_14() {
        assert_eq!(calculate_damage(14, 0, true, 1.0, false, false), 10);
    }
    #[test]
    fn weak_15() {
        assert_eq!(calculate_damage(15, 0, true, 1.0, false, false), 11);
    }
    #[test]
    fn weak_1() {
        assert_eq!(calculate_damage(1, 0, true, 1.0, false, false), 0);
    }
    #[test]
    fn weak_0_stays_0() {
        assert_eq!(calculate_damage(0, 0, true, 1.0, false, false), 0);
    }
    ...
    #[test]
    fn vuln_10() {
        assert_eq!(calculate_damage(10, 0, false, 1.0, true, false), 15);
    }
    #[test]
    fn vuln_7() {
        assert_eq!(calculate_damage(7, 0, false, 1.0, true, false), 10);
    }
    #[test]
    fn vuln_11() {
        assert_eq!(calculate_damage(11, 0, false, 1.0, true, false), 16);
    }
    #[test]
    fn vuln_1() {
        assert_eq!(calculate_damage(1, 0, false, 1.0, true, false), 1);
    }
    ...
    #[test]
    fn wrath_9() {
        assert_eq!(calculate_damage(9, 0, false, WRATH_MULT, false, false), 18);
    }
    #[test]
    fn divinity_6() {
        assert_eq!(
    ...
    fn divinity_10() {
        assert_eq!(
            calculate_damage(10, 0, false, DIVINITY_MULT, false, false),
            30
        );
    }
    ...
    #[test]
    fn intangible_1_stays() {
        assert_eq!(calculate_damage(1, 0, false, 1.0, false, true), 1);
    }
    #[test]
    fn intangible_0_stays() {
        assert_eq!(calculate_damage(0, 0, false, 1.0, false, true), 0);
    }
    ...
    fn divinity_vuln() {
        // 10*3.0*1.5 = 45
        assert_eq!(
            calculate_damage(10, 0, false, DIVINITY_MULT, true, false),
            45
        );
    }

    #[test]
    fn str_divinity_weak_vuln() {
        // (10+5)*0.75*3.0*1.5 = 50.625 -> 50
        assert_eq!(
            calculate_damage(10, 5, true, DIVINITY_MULT, true, false),
            50
        );
    }
    ...
    fn full_vigor() {
        assert_eq!(
            calculate_damage_full(
                6, 0, 5, false, false, false, false, 1.0, false, false, false, false
            ),
            11
        );
    }
    ...
    #[test]
    fn full_player_weak_ignores_paper_crane_flag() {
        // WeakPower.java applies Paper Crane only when the Weak owner is an enemy.
        assert_eq!(
            calculate_damage_full(
                10, 0, 0, true, true, false, false, 1.0, false, false, false, false
            ),
            7
        );
    }
    ...
    #[test]
    fn full_double_damage() {
        assert_eq!(
            calculate_damage_full(
                10, 0, 0, false, false, false, true, 1.0, false, false, false, false
            ),
            20
        );
    }
    ...
    #[test]
    fn full_pen_nib_wrath_vuln() {
        // 6*2(pen)*2.0(wrath)*1.5(vuln) = 36
        assert_eq!(
            calculate_damage_full(
                6, 0, 0, false, false, true, false, WRATH_MULT, true, false, false, false
            ),
            36
        );
    }
    ...
    #[test]
    fn block_neg_dex_floor() {
        assert_eq!(calculate_block(5, -10, false), 0);
    }
    #[test]
    fn block_frail_round_7() {
        assert_eq!(calculate_block(7, 0, true), 5);
    }
    #[test]
    fn block_frail_round_11() {
        assert_eq!(calculate_block(11, 0, true), 8);
    }
    #[test]
    fn block_zero() {
        assert_eq!(calculate_block(0, 0, false), 0);
    }
    #[test]
    fn block_all_negative() {
        assert_eq!(calculate_block(3, -5, true), 0);
    }
    ...
    #[test]
    fn hp_loss_intangible_1() {
        assert_eq!(apply_hp_loss(1, true, false), 1);
    }
}
