...
pub fn register(cards: &mut HashMap<&'static str, CardDef>) {
    ...
    insert(cards, CardDef {
                ...
                base_magic: -1, exhaust: false, enter_stance: None, effects: &[], effect_data: &[E::Simple(SE::GainBlock(A::Block)), E::Simple(SE::DealDamage(T::SelectedEnemy, A::Damage))], complex_hook: None,
            });
    insert(cards, CardDef {
                id: "Iron Wave+", name: "Iron Wave+", card_type: CardType::Attack,
