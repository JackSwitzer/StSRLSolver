...
pub fn register(cards: &mut HashMap<&'static str, CardDef>) {
    ...
    insert(cards, CardDef {
                ...
                effect_data: &[E::ChooseCards { source: P::Hand, filter: CardFilter::All, action: ChoiceAction::Discard, min_picks: A::Fixed(1), max_picks: A::Fixed(1), post_choice_draw: crate::effects::declarative::AmountSource::Fixed(0) }], complex_hook: None,
            });
    insert(cards, CardDef {
                id: "Survivor+", name: "Survivor+", card_type: CardType::Skill,
