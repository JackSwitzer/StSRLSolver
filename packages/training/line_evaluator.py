...
# Card effects database — auto-generated from engine card definitions.
# Covers ALL cards (all characters + colorless + curses + statuses).
# Generated lazily on first access via card_effects_gen.py.
from packages.training.card_effects_gen import get_card_effects as _get_card_effects

CARD_EFFECTS = _get_card_effects()
