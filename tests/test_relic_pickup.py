...
class TestWarPaint:
    ...
    @pytest.mark.xfail(reason="War Paint upgrade on pickup not implemented")
...
class TestWhetstone:
    ...
    @pytest.mark.xfail(reason="Whetstone upgrade on pickup not implemented")
...
class TestAstrolabe:
    ...
    @pytest.mark.xfail(reason="Astrolabe transform on pickup not implemented")
...
class TestEmptyCage:
    ...
    @pytest.mark.xfail(reason="Empty Cage removal not implemented")
...
class TestCauldron:
    ...
    @pytest.mark.xfail(reason="Cauldron potion grants not implemented")
...
class TestDollysMirror:
    ...
    @pytest.mark.xfail(reason="Dolly's Mirror duplication not implemented")
...
class TestLeesWaffle:
    ...
    @pytest.mark.xfail(reason="Lee's Waffle max HP not implemented")
    ...
    @pytest.mark.xfail(reason="Lee's Waffle heal not implemented")
...
class TestOrrery:
    ...
    @pytest.mark.xfail(reason="Orrery card selection not implemented")
...
class TestOldCoin:
    ...
    @pytest.mark.xfail(reason="Old Coin gold grant not implemented")
    ...
    @pytest.mark.xfail(reason="Old Coin Ectoplasm interaction not implemented")
