...
def main() -> int:
    ...
    parser.add_argument(
        "--manifest-json",
        type=Path,
        default=repo_root / "docs/archive/audits-2026-02-22-full-game-parity/traceability/power-manifest.json",
        help="Output JSON manifest path",
    )
    parser.add_argument(
        "--manifest-md",
        type=Path,
        default=repo_root / "docs/archive/audits-2026-02-22-full-game-parity/traceability/power-manifest.md",
